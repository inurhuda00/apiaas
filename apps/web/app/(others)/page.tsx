			...
			<section className="py-16 text-center bg-background">
				<MaxWidthWrapper className="max-w-5xl">
					...
					<h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight text-foreground">
						Delight in artistry! These <span className="text-primary">fun</span> and{" "}
						<span className="text-primary">imaginative</span> works are tailor-made for those who appreciate the{" "}
						<span className="text-primary">extraordinary</span>
					</h1>

					<p className="text-lg text-muted-foreground mb-8">🚀 No boring stocks 👋 Use however you want</p>
					...
					<div className="mt-2 text-sm text-muted-foreground">Trusted by 200+ users</div>
				</MaxWidthWrapper>
			</section>
