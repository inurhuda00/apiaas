			...
			<MaxWidthWrapper className="max-w-4xl">
				...
				<div className="prose max-w-none">
					...
					<p className="mb-4">
						...
						service, or contact us. This may include:
					</p>
					<ul className="list-disc pl-6 mb-6">
						<li className="mb-2">Your name and email address</li>
						<li className="mb-2">Billing information (if you purchase a subscription)</li>
					...
					<ul className="list-disc pl-6 mb-6">
						<li className="mb-2">Log information (IP address, browser type, pages viewed)</li>
					...
					<ul className="list-disc pl-6 mb-6">
						...
						<li className="mb-2">Send technical notices, updates, and administrative messages</li>
