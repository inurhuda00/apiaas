...
const LogoIcon = (props: SVGProps<SVGSVGElement>) => (
	<svg role="graphics-symbol" xmlns="http://www.w3.org/2000/svg" width={16} height={17} fill="none" {...props}>
		<path
			fill="currentColor"
			fillRule="evenodd"
...
const LogoSmall = (props: SVGProps<SVGSVGElement>) => (
	<svg role="graphics-symbol" xmlns="http://www.w3.org/2000/svg" width={32} height={32} fill="none" {...props}>
		<path
			fill="currentColor"
			fillRule="evenodd"
...
const Google = (props: SVGProps<SVGSVGElement>) => (
	<svg role="graphics-symbol" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}>
		<path
			fill="currentColor"
...
const Overview = (props: SVGProps<SVGSVGElement>) => (
	<svg role="graphics-symbol" xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" {...props}>
...
const DotRaster = (props: SVGProps<SVGSVGElement>) => (
	<svg role="graphics-symbol" xmlns="http://www.w3.org/2000/svg" width={8} height={8} fill="none" {...props}>
		<mask
			id="a"
			width={8}
			height={8}
...
const TimeCog = (props: SVGProps<SVGSVGElement>) => (
	<svg role="graphics-symbol" xmlns="http://www.w3.org/2000/svg" width={25} height={25} fill="none" {...props}>
		<path
			fill="currentColor"
...
const DynamicIcons = {
	...
	ArrowForward: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdOutlineArrowForward,
		})),
	),
	ArrowOutward: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdOutlineArrowOutward,
		})),
	),
	AIOutline: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdOutlineAutoAwesome,
		})),
	),
	CalendarMonth: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdOutlineCalendarMonth,
		})),
	),
	ChatBubble: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdOutlineChatBubbleOutline,
		})),
	),
	Condense: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdOutlineCloseFullscreen,
		})),
	),
	...
	ExitToApp: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdOutlineExitToApp,
		})),
	),
	Face: dynamic(() => import("react-icons/md").then((mod) => ({ default: mod.MdOutlineFace }))),
	Inventory: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdOutlineInventory2,
		})),
	),
	ExternalLink: dynamic(() => import("react-icons/md").then((mod) => ({ default: mod.MdOutlineLaunch }))),
	Time: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdOutlineMoreTime,
		})),
	),
	Notifications: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdOutlineNotificationsNone,
		})),
	),
	Security: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdOutlineSecurity,
		})),
	),
	Spellcheck: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdOutlineSpellcheck,
		})),
	),
	WrapText: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdOutlineWrapText,
		})),
	),
	...
	Strikethrough: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdFormatStrikethrough,
		})),
	),
	...
	KeyboardArrowDown: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdKeyboardArrowDown,
		})),
	),
	KeyboardArrowUp: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdKeyboardArrowUp,
		})),
	),
	...
	FileUpload: dynamic(() =>
		import("react-icons/md").then((mod) => ({
			default: mod.MdOutlineFileUpload,
		})),
	),
	FileDownload: dynamic(() =>
		import("react-icons/md").then((mod) => ({
